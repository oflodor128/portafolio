...
const Testimonials = () => {
  const testimonialStyles = `mx-auto relative max-w-[400px] h-[320px] flex flex-col justify-end
  p-16 mt-48 before:absolute before:top-[-120px] before:-ml-[110px] before:left-1/2`;
    ...
    <section id="testimonials" className="pt-32 pb-16">
        ...
        >
          ...
          <p className="mt-10 ">
          Another day on the border, another day living, another day dealing with the game in the system, trying to get dreams.
          </p>
