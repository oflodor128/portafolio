    ...
    >
      ...
      <div className="md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-32">
        {isAboveMediumScreens ? (
          ...
          before:rounded-t-[400px] before:w-full before:max-w-[600px] before:h-full before:border-2 before:border-blue before:z-[-1]"
          >
            <img
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7 text-sm text-center md:text-start">
            1.713315, -116.547868 1.713315, -116.547868 1.713315, -116.547868
            1.713315, -116.547868 1.713315, -116.547868 1.713315, -116.547868
          </p>
        </motion.div>
        {/* Call to actions */}
